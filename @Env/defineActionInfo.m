% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%% DEFINE ACTION INFO PARA ACCIONES CONTINUAS [-1, 1]^4 %%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function actionInfo = defineActionInfo()

numMotors = 4;

actionInfo = rlNumericSpec([numMotors 1], ...
    'LowerLimit', -ones(numMotors,1), ...
    'UpperLimit',  ones(numMotors,1));

actionInfo.Name = 'prosthesis_continuous_action_space';
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%% DEFINE ACTION INFO PARA ACCIONES DISCRETAS 9 ACCIONES%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function actionInfo = defineActionInfo()
