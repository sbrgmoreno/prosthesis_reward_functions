function [agent, name] = cSum_createAgent(observationInfo, actionInfo)
...
agentOptions = rlDQNAgentOptions(...
    ...
    'SequenceLength', 5, ... % default 1, Maximum batch-training trajectory length when using a recurrent neural network for the critic, specified as a positive integer. This value must be greater than 1 when using a recurrent neural network for the critic and 1 otherwise.
