function [agent, name] = cAvg_createAgent(observationInfo, actionInfo)
...
opts = rlPGAgentOptions("UseBaseline", true, ...
    "UseDeterministicExploitation", true, "DiscountFactor", 0.99, ...
    "EntropyLossWeight", 0);
...
critic.Options.LearnRate = 0.005; % default
