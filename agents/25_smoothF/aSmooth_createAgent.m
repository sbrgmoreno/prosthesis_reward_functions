function [agent, name] = aSmooth_createAgent(observationInfo, actionInfo)
...
agentOptions = rlDQNAgentOptions(...
    ...
    'TargetSmoothFactor',1e-1, ... % Smoothing factor for target critic updates, specified as a positive scalar less than or equal to 1.
