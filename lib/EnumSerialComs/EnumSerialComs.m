function devices = EnumSerialComs()
% EnumSerialComs identifies Serial COM devices on Windows systems by friendly name
% and service. Searches the Windows registry for services info and returns devices,
...
% v1.3.0.0 Modified by "Lorgio Teodovich", based on code of "Benjamin Avants"
